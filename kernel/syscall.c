...
[SYS_settickets] sys_settickets, //PROJECT2
[SYS_getpinfo] sys_getpinfo, //PROJECT2
};
...
extern int sys_settickets(void); //PROJECT2: Systemcall
extern int sys_setpinfo(void); //PROJECT 2: system call
